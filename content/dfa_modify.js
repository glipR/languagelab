...
const actualCode = localStorage.getItem('dfaModifyInvertCode') || baseCode;
...
<div id="editor" class="editor-long"></div>
...
const addContent = () => {
  ...
  window.editor.setValue(actualCode);
  window.editor.session.on('change', () => {
    localStorage.setItem('dfaModifyInvertCode', window.editor.getValue());
  });
