...
const contentText = `
Execute the DFA algorithm by dragging the red circle through the graph below, based on the word floating above.
`
...
const addContent = () => {
  ...
  MathJax.typeset();
  addScene('dfa_sim', document.querySelector('.articleBodyCenter'));
